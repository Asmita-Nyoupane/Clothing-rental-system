...
const {newComment, getComments,deleteComment} = require('../controllers/comment_controller')

const upload = require('../middleware/upload')
const { authenticateToken, createNewToken } = require('../middleware/authenticateToken')
